...
let ref_btn_0 = document.getElementById('btn_0')
let ref_btn_1 = document.getElementById('btn_1')
let ref_btn_2 = document.getElementById('btn_2')
let ref_btn_3 = document.getElementById('btn_3')
let ref_btn_4 = document.getElementById('btn_4')
let ref_btn_5 = document.getElementById('btn_5')
let ref_btn_6 = document.getElementById('btn_6')
let ref_btn_7 = document.getElementById('btn_7')
let ref_btn_8 = document.getElementById('btn_8')
let ref_btn_9 = document.getElementById('btn_9')
